...
CFLAGS   = -fPIC -g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security -Wall -fno-strict-aliasing -fPIC -Wall  $(ARCH_FLAG)
INCFLAGS = -I. -I$(arch_hdrdir) -I$(hdrdir)/ruby/backward -I$(hdrdir) -I$(srcdir)
DEFS     = 
CPPFLAGS = -DHAVE_LXC_LXC_H -D_FORTIFY_SOURCE=2 $(DEFS) $(cppflags)
...
target_prefix = 
LOCAL_LIBS = 
LIBS = $(LIBRUBYARG_SHARED) -llxc  -lpthread -lrt -ldl -lcrypt -lm   -lc
SRCS = lxc.c
OBJS = lxc.o
TARGET = lxc
DLLIB = $(TARGET).so
...
pre-install-rb-default:
	$(ECHO) installing default lxc libraries
$(RUBYARCHDIR):
	$(Q) $(MAKEDIRS) $@
